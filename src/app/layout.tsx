...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/favicons/favicon.png", sizes: "16x16", type: "image/png" },
      { url: "/favicons/favicon.png", sizes: "32x32", type: "image/png" },
      { url: "/favicons/favicon.png", sizes: "96x96", type: "image/png" },
    ],
    apple: [
      { url: "/favicons/favicon.png", sizes: "57x57", type: "image/png" },
      { url: "/favicons/favicon.png", sizes: "60x60", type: "image/png" },
      { url: "/favicons/favicon.png", sizes: "72x72", type: "image/png" },
      { url: "/favicons/favicon.png", sizes: "76x76", type: "image/png" },
      { url: "/favicons/favicon.png", sizes: "114x114", type: "image/png" },
      { url: "/favicons/favicon.png", sizes: "120x120", type: "image/png" },
      { url: "/favicons/favicon.png", sizes: "144x144", type: "image/png" },
      { url: "/favicons/favicon.png", sizes: "152x152", type: "image/png" },
      { url: "/favicons/favicon.png", sizes: "180x180", type: "image/png" },
    ],
    other: [
      {
        rel: "icon",
  ...
  other: {
    ...
    "msapplication-TileImage": "/favicons/favicon.png",
